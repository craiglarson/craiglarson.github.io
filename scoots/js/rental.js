...
fetch(rentalURL)
    ...
    for (let i = 0; i < rentals.length; i++) {
        ...
        pricingHeader.setAttribute('class', 'pricingHeader');
        ...
        reservationHeader.setAttribute('class', 'reservationHeader');
        ...
        walkInHeader.setAttribute('class', 'walkInHeader');
        ...
        reservationHeader.innerHTML = "Reservation";
        ...
        walkInHeader.innerHTML = "Walk-In";
